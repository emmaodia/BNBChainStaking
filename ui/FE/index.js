...
const StakingContractAddress = "0xA5fE5E3B969DA111d54ECf41D2CB199b9506cBE8";
...
const UGTokenContractAddress = "0xD8F752Dd3ff8B8B57B2e21D6944c43096aA34c88";
const UGTokenABI = [
  {
    anonymous: false,
    inputs: [
...
const UGContract = new ethers.Contract(
  UGTokenContractAddress,
  UGTokenABI,
  signer
);

console.log(UGTokenContractAddress);
...
function handleAmount(e) {
  ...
  // log.textContent =
  //   items == check
  //     ? `You want to send ${e} tokens, to your wallet`
  //     : `You want to send ${e} tokens, to here`;
...
const StakeTokens = async () => {
  try {
    ...
    // const check = amount.toString();
    // console.log(amount.toNumber().toString());

    console.log(amount);

    console.log("Staking works");
    const stake = await StakingContract.depositToken(0, 100);
