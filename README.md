# BNB Smart Chain Mini Staking

This is a contract where users can stake UGToken in the Pool to earn BREAD Tokens.

There are currently 5 functions/methods:
...
**It is a fork of the PancakeSwap MasterChef Contract**

It is built using the BNB Chain Truffle Box.
